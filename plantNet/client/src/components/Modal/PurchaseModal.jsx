...
const PurchaseModal = ({ closeModal, isOpen, plant, refetch }) => {
  ...
  const handleQuantity = (value) => {
    if (value > quantity) {
      ...
      return toast.error("quantity exceeds in your stock");
    }

    if (value < 0) {
      setTotalQuantity(1);
      return toast.error("Quantity less then stock");
    }
  ...
  const handlePurchase = async () => {
    try {
      ...
      toast.success("Order Purchase Successful");
      refetch();
    } catch (error) {
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                {/* quantity field */}
                <div className="space-x-2 text-sm mt-1.5">
                ...
                <div className="space-x-2 text-sm mt-1.5">
                  ...
                  <input
                    ...
                    id="address"
                    type="text"
                    placeholder="Shipping your address..."
                    required
                  />
                </div>
                {/* button */}
